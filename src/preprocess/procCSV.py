...
with open('data/main/ambari.csv', newline='') as csvfile:
        ...
        print('issue_id, type, status, resolution, component, priority, reporter, created, '
              'assigned, assignee, resolved, created, assigned, summary, description, '
              'affected_version, fixed_version, votes, watches, description_words, '
              'assingnee_count, comment_count, commenter, Surprising, Dormant, '
        ...
        for row in reader:
            ...
            output += row['commenter'] in (None, '') and '' or row['commenter']+","
